...
_To turn off the virtual enviroment use **deactivate** in terminal_
...
2. To cooperate, download the dependencies: **npm install**;
2. Execute **npx cypress open** to execute visually the tests.

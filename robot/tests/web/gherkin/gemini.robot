...
*** Test Cases ***
Gherkin Gemini Test
    Given Open Target Website    url=https://gemini.google.com/    use_user_data_dir=${True}
    ...
    And Add Local File Into Gemini    title_file_explorer=Open Files    base_path=Pictures    file_name=for_gemini_test.png
